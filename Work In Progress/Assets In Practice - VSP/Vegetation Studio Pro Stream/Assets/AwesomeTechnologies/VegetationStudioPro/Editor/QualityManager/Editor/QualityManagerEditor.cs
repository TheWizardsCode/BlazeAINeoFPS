    ...
    public class QualityManagerEditor : VegetationStudioProBaseEditor
    {
        ...
        public override void OnInspectorGUI()
        {
            ...
            EditorGUILayout.HelpBox(
                "Creating quality levels will clear old settings and add new empty settings based on the Quality settings in Unity.",
                MessageType.Info);
            ...
            EditorGUILayout.HelpBox(
                "Make sure you have a directional light assigned on the render tab when using billboard shadows.",
                MessageType.Info);
            GUILayout.EndVertical();
